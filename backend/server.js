...
const settingsHandler = require('./services/Settings')(DB);
...
app.get('/settings',              authMiddleware, settingsHandler.getSettings);
app.put('/settings/username',     authMiddleware, settingsHandler.updateUsername);
app.put('/settings/email',        authMiddleware, settingsHandler.updateEmail);
app.put('/settings/password',     authMiddleware, settingsHandler.updatePassword);
app.put('/settings/language',     authMiddleware, settingsHandler.updateLanguage);
app.put('/settings/theme',        authMiddleware, settingsHandler.updateTheme);
